...
Page({
  ...
  data: {
    ...
    rule: 'up',
    items: [
      { name: 'up', value: '高于极限值报警' ,checked:'ture'},
      { name: 'down', value: '低于极限值报警' },
    ]
  },
  ...
  send: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=%E5%8C%97%E4%BA%AC&output=json&ak=PLFRLfF7q1vTPEV79MVxspo5ekbyDD5v', //百度天气API
      header: {
